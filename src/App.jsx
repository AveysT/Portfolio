...
function App() {
  ...
  return (
    <>
      <div className="dark:bg-gray-800  grid grid-rows-[1fr_1fr] h-dvh items-center">
          ...
          <section className="flex flex-col items-center">
            <article className="flex flex-col justify-center items-center gap-5">
              <div className="flex flex-row">
                <h1 className="dark:text-gray-200 text-main text-6xl text-center flex items-center">
                  Hi, I'm Alejandro Torquemada
                  <h1 className="dark:text-gray-200 text-main text-6xl flex items-center animate-codebar max-lg:hidden">
                    |
                  </h1>
                </h1>
              </div>
              <p className="dark:text-gray-100 text-submain text-2xl">
                Front End Developer
              </p>
        ...
        <section className="h-[100%] flex flex-col m-auto pt-20 pb-20">
          <article className="w-screen max-w-3xl flex flex-col gap-3 p-4">
            <div className="flex flex-col gap-2">
              <h2 className="dark:text-gray-200 text-3xl text-main">
                What I do
              </h2>
              <ul className="text-m list-disc list-inside">
                <li className="dark:text-gray-100 text-submain ">
                  Write HTML with a proper semantic
                </li>
                <li className="dark:text-gray-100 text-submain ">
                  Find the best style in CSS
                </li>
                <li className="dark:text-gray-100 text-submain ">
                  Create funcitions that helps and make the web interactive
                </li>
                <li className="dark:text-gray-100 text-submain ">
                  RESTful APIs and components are the way to go
                </li>
                <li className="dark:text-gray-100 text-submain ">
                  Always keep updated
                </li>
              </ul>
              <p className="dark:text-gray-100 text-submain  text-xs self-end">
      ...
      <div className="dark:bg-gray-800 dark:text-white grid grid-rows-[1fr_1fr] h-dvh items-center">
        <header className="h-auto flex flex-col m-auto items-center pt-30">
        ...
        <footer className="h-[100%] flex flex-col m-auto pt-20 pb-20 items-center">
          <h2 className="dark:text-gray-200 text-3xl text-main">Socials</h2>
          <section className="flex flex-row items-center gap-4 mt-10 mb-10 max-2xl:flex-col">
            <div className="flex flex-row gap-4 rounded-lg hover:shadow-[0px_0px_16px_0px_rgba(0,_0,_0,_0.3)] transition-all duration-300">
              <div className="dark:bg-gray-600 flex flex-row gap-2 text-3xl border-2 border-r-0 border-gray-400 bg-gray-200 p-4 rounded-l-lg justify-center items-center ">
                <SlEnvolope />
              </div>
              <div className="dark:text-gray-100 dark:bg-gray-600 text-submain -ml-6 flex flex-row gap-2 border-2 border-l-gray-200 border-r-gray-200 border-gray-400 bg-gray-100 p-4 -z-10">
                <p className="dark:text-gray-100 text-lg">
                  Alejandrotorquemada@gmail.com
                </p>
              </div>
              <button
                onClick={mailCopy}
                className="dark:bg-gray-600 hover:dark:bg-gray-700 -ml-6 flex flex-row gap-2 text-3xl border-2 border-l-0 border-gray-400 bg-gray-200 p-4 rounded-r-lg justify-center items-center hover:bg-gray-300 transition-colors duration-300"
              >
                <SlDocs />
              </button>
            </div>
